...
APIGuard's Report Generator (L7) produces output in four formats. Machine-readable formats (JSON, SARIF) are generated by the Go layer. Human-readable formats (HTML, PDF) are generated by the Python layer using Jinja2 templates.
...
| HTML | Python + Jinja2 | Human review, team distribution, presentations | No | No |
| PDF | Python + Jinja2 + WeasyPrint | Compliance, audit evidence, offline distribution | No | No |
