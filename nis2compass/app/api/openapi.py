        ...
        "schemas": {
            "Error": {
                ...
                "properties": {
                    ...
                    "code": {"type": "string", "enum": [
                        ...
                        "FORBIDDEN", "CONFLICT", "RATE_LIMITED", "INTERNAL_ERROR"
                    ]}
                }
            },
            "Organisation": {
            ...
            "Assessment": {
                ...
                "properties": {
                    ...
                    "title": {"type": "string"},
                    "status": {"type": "string", "enum": ["draft", "in_progress", "under_review", "completed", "archived"]},
            ...
            "Control": {
                ...
                "properties": {
                    ...
                    "nist_category": {"type": "string", "enum": ["identify", "protect", "detect", "respond", "recover"]},
                    "title": {"type": "string"},
                    "status": {"type": "string", "enum": ["not_assessed", "compliant", "partially_compliant", "non_compliant", "not_applicable"]},
            ...
            "Artifact": {
                ...
                "properties": {
                    ...
                    "type": {"type": "string", "enum": ["policy", "procedure", "evidence", "report", "screenshot", "log", "certificate", "contract"]},
    ...
    "paths": {
        "/health": {
            "get": {
                ...
                "security": [],
                "responses": {
                    "200": {"description": "Service is running", "content": {"application/json": {"schema": {"type": "object", "properties": {"status": {"type": "string"}, "version": {"type": "string"}}}}}}
                }
            }
        },
        "/auth/token": {
        ...
        "/organisations": {
            "get": {
                ...
                "responses": {
                    "200": {"description": "List of organisations", "headers": {"X-Total-Count": {"schema": {"type": "integer"}}}, "content": {"application/json": {"schema": {"type": "array", "items": {"$ref": "#/components/schemas/Organisation"}}}}}
                }
            },
            "post": {
                "tags": ["Organisations"],
                ...
                "requestBody": {
                    "required": True,
                    "content": {"application/json": {"schema": {"type": "object", "required": ["name", "industry", "country"], "properties": {"name": {"type": "string"}, "industry": {"type": "string"}, "country": {"type": "string"}, "size": {"type": "string", "enum": ["micro", "small", "medium", "large"]}, "entity_type": {"type": "string", "enum": ["essential", "important"]}, "registration_number": {"type": "string"}, "contact_email": {"type": "string"}}}}}
                },
                "responses": {
        ...
        "/organisations/{id}": {
            ...
            "get": {"tags": ["Organisations"], "summary": "Get organisation", "responses": {"200": {"content": {"application/json": {"schema": {"$ref": "#/components/schemas/Organisation"}}}}, "404": {"description": "Not found"}}},
            "patch": {"tags": ["Organisations"], "summary": "Update organisation", "requestBody": {"content": {"application/json": {"schema": {"$ref": "#/components/schemas/Organisation"}}}}, "responses": {"200": {"content": {"application/json": {"schema": {"$ref": "#/components/schemas/Organisation"}}}}}},
            "delete": {"tags": ["Organisations"], "summary": "Delete organisation", "responses": {"204": {"description": "Deleted"}, "404": {"description": "Not found"}}}
        },
        "/organisations/{org_id}/assessments": {
            "parameters": [{"name": "org_id", "in": "path", "required": True, "schema": {"type": "string", "format": "uuid"}}],
            "get": {"tags": ["Assessments"], "summary": "List assessments for organisation", "parameters": [{"name": "status", "in": "query", "schema": {"type": "string"}}, {"name": "page", "in": "query", "schema": {"type": "integer"}}, {"name": "per_page", "in": "query", "schema": {"type": "integer"}}], "responses": {"200": {"content": {"application/json": {"schema": {"type": "array", "items": {"$ref": "#/components/schemas/Assessment"}}}}}}},
            "post": {"tags": ["Assessments"], "summary": "Create assessment (auto-creates 10 controls)", "requestBody": {"required": True, "content": {"application/json": {"schema": {"type": "object", "required": ["title"], "properties": {"title": {"type": "string"}, "framework_version": {"type": "string"}, "scope": {"type": "string"}, "assessor": {"type": "string"}, "due_date": {"type": "string", "format": "date"}}}}}}, "responses": {"201": {"content": {"application/json": {"schema": {"$ref": "#/components/schemas/Assessment"}}}}}}
        },
        "/assessments/{id}": {
            "parameters": [{"name": "id", "in": "path", "required": True, "schema": {"type": "string", "format": "uuid"}}],
            "get": {"tags": ["Assessments"], "summary": "Get assessment with stats", "responses": {"200": {"content": {"application/json": {"schema": {"$ref": "#/components/schemas/Assessment"}}}}}},
            "patch": {"tags": ["Assessments"], "summary": "Update assessment status/fields", "responses": {"200": {"content": {"application/json": {"schema": {"$ref": "#/components/schemas/Assessment"}}}}}},
            "delete": {"tags": ["Assessments"], "summary": "Delete assessment", "responses": {"204": {"description": "Deleted"}}}
        },
        "/assessments/{id}/controls": {
            "parameters": [{"name": "id", "in": "path", "required": True, "schema": {"type": "string", "format": "uuid"}}],
            "get": {"tags": ["Controls"], "summary": "List controls for assessment", "parameters": [{"name": "status", "in": "query", "schema": {"type": "string"}}, {"name": "nist_category", "in": "query", "schema": {"type": "string"}}, {"name": "measure_ref", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"content": {"application/json": {"schema": {"type": "array", "items": {"$ref": "#/components/schemas/Control"}}}}}}}
        },
        ...
        "/assessments/{id}/artifacts": {
            "parameters": [{"name": "id", "in": "path", "required": True, "schema": {"type": "string", "format": "uuid"}}],
            "get": {"tags": ["Artifacts"], "summary": "List artifacts for assessment", "parameters": [{"name": "control_id", "in": "query", "schema": {"type": "string", "format": "uuid"}}, {"name": "type", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"content": {"application/json": {"schema": {"type": "array", "items": {"$ref": "#/components/schemas/Artifact"}}}}}}},
            "post": {"tags": ["Artifacts"], "summary": "Upload artifact", "requestBody": {"required": True, "content": {"multipart/form-data": {"schema": {"type": "object", "required": ["file", "type"], "properties": {"file": {"type": "string", "format": "binary"}, "type": {"type": "string"}, "control_id": {"type": "string", "format": "uuid"}, "description": {"type": "string"}}}}}}, "responses": {"201": {"content": {"application/json": {"schema": {"$ref": "#/components/schemas/Artifact"}}}}, "413": {"description": "File too large"}}}
        },
        "/artifacts/{id}": {
            "parameters": [{"name": "id", "in": "path", "required": True, "schema": {"type": "string", "format": "uuid"}}],
        ...
        "/audit": {
            "get": {
                ...
                "parameters": [
                    ...
                    {"name": "risk_class", "in": "query", "schema": {"type": "string", "enum": ["INFO", "WARNING", "CRITICAL"]}},
                    {"name": "after", "in": "query", "schema": {"type": "string", "format": "date-time"}, "description": "Return entries after this ISO 8601 timestamp (cursor-based polling)"},
                    {"name": "page", "in": "query", "schema": {"type": "integer", "default": 1}},
                    {"name": "per_page", "in": "query", "schema": {"type": "integer", "default": 20}}
                ],
                "responses": {
                    "200": {"description": "Audit entries", "headers": {"X-Total-Count": {"schema": {"type": "integer"}}}, "content": {"application/json": {"schema": {"type": "array", "items": {"$ref": "#/components/schemas/AuditEntry"}}}}}
                }
            }
        },
        "/audit/{id}": {
