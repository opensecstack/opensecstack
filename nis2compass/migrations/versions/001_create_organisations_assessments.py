...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('size',                sa.Enum('micro', 'small', 'medium', 'large', name='org_size'), nullable=False, server_default='medium'),
        sa.Column('entity_type',         sa.Enum('essential', 'important', name='entity_type'), nullable=False, server_default='important'),
    ...
    op.create_table(
        ...
        sa.Column('status',            sa.Enum('draft', 'in_progress', 'under_review', 'completed', 'archived', name='assessment_status'), nullable=False, server_default='draft'),
