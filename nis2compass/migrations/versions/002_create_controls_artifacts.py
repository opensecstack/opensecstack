...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('nist_category',    sa.Enum('identify', 'protect', 'detect', 'respond', 'recover', name='nist_category'), nullable=False),
        sa.Column('title',            sa.String(255), nullable=False),
        sa.Column('description',      sa.Text,        nullable=True),
        sa.Column('status',           sa.Enum('not_assessed', 'compliant', 'partially_compliant', 'non_compliant', 'not_applicable', name='control_status'), nullable=False, server_default='not_assessed'),
    ...
    op.create_table(
        ...
        sa.Column('type',          sa.Enum('policy', 'procedure', 'evidence', 'report', 'screenshot', 'log', 'certificate', 'contract', name='artifact_type'), nullable=False),
