...
async function call(path, opts, schema) {
...
export const api = {
    ...
    scan: (input, context = "default") => call("/api/v1/prompt/scan", { method: "POST", body: JSON.stringify({ input, context }) }, ScanResponse),
    atlasCoverage: () => call("/api/v1/threatfeed/atlas/coverage", { method: "GET" }, z.any()),
